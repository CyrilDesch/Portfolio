const tabProject = [
  ...
  },
  {
    ...
    image: "./assets/healven.jpg",
    typeProject: "app",
  },
  {
    title: "PortfolioV1",
    redirection: 'https://github.com/CyrilDesch/PortfolioV1',
    description: "Ce site a pour but de me présenter rapidement moi ainsi que mes projets. Celui-ci a été développé avec React JS pour continuer à améliorer mon bagage technique. Mon objectif, durant ce projet, était d'apprendre à animer, de la meilleure des façons, plusieurs types de composants.",
  ...
  }, 
  {
    ...
    image: "./assets/ruckfield.jpg",
    typeProject: "site",
  },
  {
    title: "FoodYril",
    redirection: 'https://github.com/CyrilDesch/FoodYril-Ancienne-Version/blob/main/README.md',
